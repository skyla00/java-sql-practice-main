...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users (username, email, password) VALUES ('하늘', 'halofu@naver.com', '12345'); ";
  ...
  */
  public static final String PART2_8 = "SELECT title, u.username FROM Posts p " +
  ...
  */
  public static final String PART2_10 = "INSERT INTO Posts (title, content, user_id) VALUES ('냠냠', '냐냐', 1) ";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 post의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "SELECT * FROM Posts p LEFT JOIN Boards b " +
          "ON p.board_id = b.board_id WHERE b.board_id IS NULL;";
  ...
  */
  public static final String PART2_13 = "SELECT b.name FROM Users u " +
  ...
  */
  public static final String PART2_16 = "SELECT u.username AS username, COUNT(c.comment_id) " +
          "AS CommentCount FROM Users u " +
  ...
  */
  public static final String PART2_18 = "SELECT b.name, AVG(LENGTH(p.content)) AS length_con FROM Boards b " +
  ...
  */
  public static final String PART2_20 = "SELECT t.name, COUNT(pt.post_id) AS PostCount FROM Tags t " +
